...
// newTestCacheWithDisk creates an FSStore with a configured maxDisk for eviction tests.
func newTestCacheWithDisk(t *testing.T, maxMemory, maxDisk int64) *FSStore {
	t.Helper()
	dir := t.TempDir()
